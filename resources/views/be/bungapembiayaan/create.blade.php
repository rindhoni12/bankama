...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tile">
            ...
            <div class="tile-body">
                <form method="post" action="{{ route('bungapembiayaan.store') }}" class="form-horizontal"
                    ...
                    <div class="tile-footer">
                        <div class="row">
                            <div class="col-md-12 col-md-offset-3 text-right">
                                ...
                                <a class="btn btn-secondary" href="{{ route('bungapembiayaan.index') }}">
