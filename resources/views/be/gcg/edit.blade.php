...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tile">
            ...
            <div class="tile-body">
                <form method="post" action="{{ route('gcg.update', $gcg->id) }}" class="form-horizontal"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="judul" placeholder="Judul Laporan"
                                autocomplete="off" value="{{ old('judul') ?? $gcg->judul }}">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="tanggal" placeholder="Tahun Laporan"
                                autocomplete="off" value="{{ old('tanggal') ?? $gcg->tanggal }}">
                        </div>
                    </div>
                    <div class="tile-footer">
                        <div class="row">
                            <div class="col-md-12 col-md-offset-3 text-right">
                                ...
                                <a class="btn btn-secondary" href="{{ route('gcg.index') }}"><i
