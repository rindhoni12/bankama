...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tile">
            <h3 class="tile-title text-capitalize">Ubah {{ Request::segment(1) . ' ' . $ilustrasi->no_slide}} </h3>
            <div class="tile-body">
                <form method="post" action="{{ route('ilustrasi.update', $ilustrasi->id) }}" class="form-horizontal"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="banner">Ubah Banner {{ ucfirst($ilustrasi->posisi) }} (Optional)</label>
                        ...
                        <div class="form-group col-md-12">
                            <input type="text" class="form-control" name="posisi" placeholder="Posisi"
                                autocomplete="off" value="{{ old('posisi') ?? $ilustrasi->posisi }}" hidden>
                        </div>
                    </div>
                    ...
                    <div class="tile-footer">
                        <div class="row">
                            <div class="col-md-12 col-md-offset-3 text-right">
                                ...
                                <a class="btn btn-secondary" href="{{ route('ilustrasi.index') }}">
