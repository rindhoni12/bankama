...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tile">
            ...
            <div class="tile-body">
                <form method="post" action="{{ route('jenisproduk.update', $jenisproduk->id) }}" class="form-horizontal"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="jenis_produk" autocomplete="off"
                                value="{{ old('jenis_produk') ?? $jenisproduk->jenis_produk }}">
                        </div>
                    </div>
