...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tile">
            ...
            <div class="tile-body">
                <form method="post" action="{{ route('produklayanan.update', $produklayanan->id) }}"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            <label for="foto_thumbnail">Ubah Foto Thumbnail (Optional)</label>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="nama_produklayanan"
                                ...
                                value="{{ old('nama_produklayanan') ?? $produklayanan->nama_produklayanan }}">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" id="jenis_tabungan" name="jenis_tabungan">
                                ...
                                <option value="{{ $kategori->slug }}" {{ $kategori->slug ==
                                    $produklayanan->jenis_tabungan ? 'selected' : ''}}>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="deskripsi" class="my-editor form-control" id="my-editor" cols="30"
                                rows="10">{{ old('deskripsi') ?? $produklayanan->deskripsi }}</textarea>
                        </div>
                    </div>
