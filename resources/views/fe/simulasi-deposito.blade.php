            ...
            <div class="simulasi-header">
                <div class="container">
                    <div class="breadc-box no-line">
                        <div class="row">
                            <div class="col-md-6">
                                <h1 class="page-title">Simulasi Deposito</h1>
                            </div>
                                    ...
                                    <div class="wpb_column column_container col-sm-12">
                                        <div class="column-inner">
                                            <div class="wpb_wrapper">
                                                <h2 class="custom_heading text-light">Simulasi Deposito Standar</h2>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-12" style="margin-bottom: 30px">
                                            <h2 class="custom-heading text-center">Simulasi Deposito Anda</h2>
                                        </div>
                                        <div class="col-12" style="margin-left: 30px">
                                            ...
                                            <div class="col-12">
                                                Total Nominal saat Jatuh Tempo
                                                <span style="margin-left:20px">: </span>
                                                <span id="resultTotalPengembalianDeposito"
                                                    style="font-weight: bold">:</span>
                                            </div>
                                            <div class="col-12">
                                                Total Akumulasi Bunga
                                                <span style="margin-left:19px">: </span>
                                                <span id="resultBungaBersih" style="font-weight: bold">:</span>
                                            </div>
                                            {{-- <div class="col-12">
        ...
        $(document).ready(function() {
            ...
            $('#simulasiKredit').on('submit',function(e){
                ...
                if (jumlahKredit.length == 0) {
                    alert("Isi dulu jumlah Deposito");
                } else if (jangkaWaktu.length == 0) {
                    alert("Pilih salah satu jangka waktu deposito");
                } else {
                    $.ajax({
                        url: '{{ route('hitung.deposito') }}',
                        type: 'POST',
                        data: $(this).serialize(),
                        success: function(response){
                            // console.log(response.angsuran);
                            $('#resultTotalPinjaman').text(rupiah_format(response.jumlahKredit));
                            $('#resultLamaPinjaman').text(response.jangkaWaktu + " Hari");
                            $('#resultBungaPertahun').text(response.sukubungaPertahun + "%");

                            $('#resultTotalPengembalianDeposito').text(rupiah_format(response.totalPengembalianDeposito));
                            $('#resultBungaBersih').text(rupiah_format(response.bungaBersih));
